...
inline constexpr std::uint32_t kMinimapGetInstance = 0x40DC30;
inline constexpr std::uint32_t kMinimapUpdateGridDisplay = 0x40E210;
...
inline constexpr std::uint32_t kMainCameraTailFollowUpdate = 0x424440;
inline constexpr std::uint32_t kFlushMainCameraTailYaw = 0x423FF0;
...
inline constexpr std::uint32_t kAnimationSetPlaybackRate = 0x669BA0;
