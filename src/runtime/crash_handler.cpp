...
std::string BuildCrashReportText(
    ...
    out
        ...
        << "gi_talk_volume=" << runtime_snapshot->gi_talk_volume << "\n"
        << "gi_talk_volume_applied=" << (runtime_snapshot->gi_talk_volume_applied ? 1 : 0) << "\n"
        << "gi_talk_volume_summary=" << runtime_snapshot->gi_talk_volume_summary << "\n"
        << "gamepad_enabled=" << (runtime_snapshot->gamepad_enabled ? 1 : 0) << "\n"
        << "gamepad_connected=" << (runtime_snapshot->gamepad_connected ? 1 : 0) << "\n"
        << "gamepad_context=" << ToString(runtime_snapshot->gamepad_context) << "\n"
        << "gamepad_modern_controls=" << (runtime_snapshot->gamepad_modern_controls ? 1 : 0) << "\n"
        << "gamepad_preserve_free_camera=" << (runtime_snapshot->gamepad_preserve_free_camera ? 1 : 0) << "\n"
        << "gamepad_run_threshold=" << runtime_snapshot->gamepad_run_threshold << "\n"
        << "gamepad_fast_run_threshold=" << runtime_snapshot->gamepad_fast_run_threshold << "\n"
        << "gamepad_camera_sensitivity=" << runtime_snapshot->gamepad_camera_sensitivity << "\n"
