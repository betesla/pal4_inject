...
struct CeguiBindings {
    ...
    using ImagesetManagerGetImagesetFn = void* (__thiscall*)(void*, const void*);
    using ImagesetGetTextureFn = void* (__thiscall*)(const void*);
    ...
    using FontGetLineSpacingFn = float (__thiscall*)(void*, float);
    using FontGetPointSizeFn = std::uint32_t (__thiscall*)(void*);
    using FontGetWrappedTextExtentFn = float (__thiscall*)(void*, const void*, float, float);
    using FontCreateFromFtFaceFn = void (__thiscall*)(void*, std::uint32_t, std::uint32_t, std::uint32_t);
    ...
    GetSingletonPtrFn get_imageset_manager_singleton_ptr = nullptr;
    ...
    ImagesetManagerGetImagesetFn imageset_manager_get_imageset = nullptr;
    ImagesetGetTextureFn imageset_get_texture = nullptr;
    ...
    FontGetLineSpacingFn font_get_line_spacing = nullptr;
    FontGetPointSizeFn font_get_point_size = nullptr;
    FontGetWrappedTextExtentFn font_get_wrapped_text_extent = nullptr;
    FontCreateFromFtFaceFn font_create_font_from_ft_face = nullptr;
